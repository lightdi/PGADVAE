...
class Generator(nn.Module):
    """
         ...
         Generator Class to generate images from progressive way
    
    """
    def __init__(self, latent_dim, channel_num, out_resolution_dim, noise_dim=50):
        ...
        self.gen_fc = nn.Linear(latent_dim + noise_dim, (first_channels*4*4), bias=False)
