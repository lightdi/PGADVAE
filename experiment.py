import os
from models.PDecoder import Decoder
from models.PEncoder import Encoder
from models.PDiscriminator import Discriminator
from models.PGenerator import Generator
import numpy as np
import torch as t
...
class AVAE(LightningModule):
    def __init__(
        ...
        **kwargs):
        ...
        self.schedule = [[1000, 2000, 3000, 4000], [16, 16, 16, 8],[5, 5, 5, 1]]
    ...
    def configure_optimizers(self):
        ...
        #optimizer_G = t.optim.SGD(self.G.parameters(),
        #                                lr=lr, momentum=0.5)
